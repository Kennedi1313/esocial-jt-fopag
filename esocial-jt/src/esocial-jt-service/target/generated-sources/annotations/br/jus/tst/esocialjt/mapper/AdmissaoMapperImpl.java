...
import br.jus.tst.esocial.dominio.vinculo.Desligamento;
import br.jus.tst.esocial.dominio.vinculo.FGTS;
import br.jus.tst.esocial.dominio.vinculo.HorContratual;
import br.jus.tst.esocial.dominio.vinculo.IdeTrabSubstituido;
...
public class AdmissaoMapperImpl extends AdmissaoMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Endereco enderecoToEndereco(Endereco endereco) {
        if ( endereco == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Endereco endereco1 = objectFactory.createESocialEvtAdmissaoTrabalhadorEndereco();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.TrabImig trabImigToTrabImig(TrabImig trabImig) {
        if ( trabImig == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.TrabImig trabImig1 = objectFactory.createESocialEvtAdmissaoTrabalhadorTrabImig();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.InfoDeficiencia infoDeficienciaToInfoDeficiencia(InfoDeficiencia infoDeficiencia) {
        if ( infoDeficiencia == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.InfoDeficiencia infoDeficiencia1 = objectFactory.createESocialEvtAdmissaoTrabalhadorInfoDeficiencia();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente dependenteToDependente(Dependente dependente) {
        if ( dependente == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente dependente1 = objectFactory.createESocialEvtAdmissaoTrabalhadorDependente();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente> dependenteListToDependenteList(List<Dependente> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente>( list.size() );
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador trabalhadorToTrabalhador(Trabalhador trabalhador) {
        if ( trabalhador == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador trabalhador1 = objectFactory.createESocialEvtAdmissaoTrabalhador();
        ...
        if ( trabalhador1.getDependente() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Trabalhador.Dependente> list = dependenteListToDependenteList( trabalhador.getDependente() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.FGTS fGTSToFGTS(FGTS fGTS) {
        if ( fGTS == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.FGTS fGTS1 = objectFactory.createESocialEvtAdmissaoVinculoInfoRegimeTrabInfoCeletistaFGTS();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido ideTrabSubstituidoToIdeTrabSubstituido(IdeTrabSubstituido ideTrabSubstituido) {
        if ( ideTrabSubstituido == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido ideTrabSubstituido1 = objectFactory.createESocialEvtAdmissaoVinculoInfoRegimeTrabInfoCeletistaTrabTemporarioIdeTrabSubstituido();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido> ideTrabSubstituidoListToIdeTrabSubstituidoList(List<IdeTrabSubstituido> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido>( list.size() );
        for ( IdeTrabSubstituido ideTrabSubstituido : list ) {
    ...
    protected TrabTemporario trabTemporarioToTrabTemporario(br.jus.tst.esocial.dominio.vinculo.TrabTemporario trabTemporario) {
        ...
        if ( trabTemporario1.getIdeTrabSubstituido() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario.IdeTrabSubstituido> list = ideTrabSubstituidoListToIdeTrabSubstituidoList( trabTemporario.getIdeTrabSubstituido() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista infoCeletistaToInfoCeletista(InfoCeletista infoCeletista) {
        if ( infoCeletista == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab.InfoCeletista infoCeletista1 = objectFactory.createESocialEvtAdmissaoVinculoInfoRegimeTrabInfoCeletista();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab infoRegimeTrabToInfoRegimeTrab(InfoRegimeTrab infoRegimeTrab) {
        if ( infoRegimeTrab == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoRegimeTrab infoRegimeTrab1 = objectFactory.createESocialEvtAdmissaoVinculoInfoRegimeTrab();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Duracao duracaoToDuracao(Duracao duracao) {
        if ( duracao == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Duracao duracao1 = objectFactory.createESocialEvtAdmissaoVinculoInfoContratoDuracao();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes observacoesToObservacoes(Observacoes observacoes) {
        if ( observacoes == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes observacoes1 = objectFactory.createESocialEvtAdmissaoVinculoInfoContratoObservacoes();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes> observacoesListToObservacoesList(List<Observacoes> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes>( list.size() );
        for ( Observacoes observacoes : list ) {
    ...
    protected InfoContrato infoContratoToInfoContrato(br.jus.tst.esocial.dominio.vinculo.InfoContrato infoContrato) {
        ...
        if ( infoContrato1.getObservacoes() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.InfoContrato.Observacoes> list = observacoesListToObservacoesList( infoContrato.getObservacoes() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.SucessaoVinc sucessaoVincToSucessaoVinc(SucessaoVinc sucessaoVinc) {
        if ( sucessaoVinc == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.SucessaoVinc sucessaoVinc1 = objectFactory.createESocialEvtAdmissaoVinculoSucessaoVinc();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.TransfDom transfDomToTransfDom(TransfDom transfDom) {
        if ( transfDom == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.TransfDom transfDom1 = objectFactory.createESocialEvtAdmissaoVinculoTransfDom();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.MudancaCPF mudancaCPFToMudancaCPF(MudancaCPF mudancaCPF) {
        if ( mudancaCPF == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.MudancaCPF mudancaCPF1 = objectFactory.createESocialEvtAdmissaoVinculoMudancaCPF();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.Afastamento afastamentoToAfastamento(Afastamento afastamento) {
        if ( afastamento == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.Afastamento afastamento1 = objectFactory.createESocialEvtAdmissaoVinculoAfastamento();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.Desligamento desligamentoToDesligamento(Desligamento desligamento) {
        if ( desligamento == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.admissao.ESocial.EvtAdmissao.Vinculo.Desligamento desligamento1 = objectFactory.createESocialEvtAdmissaoVinculoDesligamento();
