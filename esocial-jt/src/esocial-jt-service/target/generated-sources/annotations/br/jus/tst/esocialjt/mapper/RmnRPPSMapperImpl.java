...
import br.jus.tst.esocial.dominio.demonstrativovalores.InfoPerApur;
...
public class RmnRPPSMapperImpl extends RmnRPPSMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.IdeTrabalhador ideTrabalhadorToIdeTrabalhador(IdeTrabalhador ideTrabalhador) {
        if ( ideTrabalhador == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.IdeTrabalhador ideTrabalhador1 = objectFactory.createESocialEvtRmnRPPSIdeTrabalhador();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerApur.IdeEstab ideEstabToIdeEstab(IdeEstab ideEstab) {
        if ( ideEstab == null ) {
            return null;
        }
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerApur.IdeEstab> ideEstabListToIdeEstabList(List<IdeEstab> list) {
        if ( list == null ) {
            return null;
        }
    ...
    protected br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerApur infoPerApurToInfoPerApur(InfoPerApur infoPerApur) {
        if ( infoPerApur == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerApur infoPerApur1 = objectFactory.createESocialEvtRmnRPPSDmDevInfoPerApur();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab ideEstabToIdeEstab1(br.jus.tst.esocial.dominio.beneficio.demonstrativovalores.IdeEstab ideEstab) {
        if ( ideEstab == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab ideEstab1 = objectFactory.createESocialEvtRmnRPPSDmDevInfoPerAntIdePeriodoIdeEstab();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab> ideEstabListToIdeEstabList1(List<br.jus.tst.esocial.dominio.beneficio.demonstrativovalores.IdeEstab> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab>( list.size() );
    ...
    protected IdePeriodo idePeriodoToIdePeriodo(br.jus.tst.esocial.dominio.beneficio.demonstrativovalores.IdePeriodo idePeriodo) {
        ...
        if ( idePeriodo1.getIdeEstab() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt.IdePeriodo.IdeEstab> list = ideEstabListToIdeEstabList1( idePeriodo.getIdeEstab() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt infoPerAntToInfoPerAnt(InfoPerAnt infoPerAnt) {
        if ( infoPerAnt == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.rmnrpps.ESocial.EvtRmnRPPS.DmDev.InfoPerAnt infoPerAnt1 = objectFactory.createESocialEvtRmnRPPSDmDevInfoPerAnt();
