...
import br.jus.tst.esocial.dominio.tabela.rubrica.IdeProcessoCP;
...
public class TabelaRubricaMapperImpl extends TabelaRubricaMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP ideProcessoCPToIdeProcessoCP(IdeProcessoCP ideProcessoCP) {
        if ( ideProcessoCP == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP ideProcessoCP1 = objectFactory.createTDadosRubricaIdeProcessoCP();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP> ideProcessoCPListToIdeProcessoCPList(List<IdeProcessoCP> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP>( list.size() );
        for ( IdeProcessoCP ideProcessoCP : list ) {
    ...
    protected TDadosRubrica dadosRubricaToTDadosRubrica(DadosRubrica dadosRubrica) {
        ...
        if ( tDadosRubrica.getIdeProcessoCP() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.tabrubrica.TDadosRubrica.IdeProcessoCP> list = ideProcessoCPListToIdeProcessoCPList( dadosRubrica.getIdeProcessoCP() );
            if ( list != null ) {
    ...
    protected Inclusao infoRubricaToInclusao(InfoRubrica infoRubrica) {
        if ( infoRubrica == null ) {
            return null;
        }
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tabrubrica.ESocial.EvtTabRubrica.InfoRubrica tabelaRubricaToInfoRubrica(TabelaRubrica tabelaRubrica) {
        if ( tabelaRubrica == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tabrubrica.ESocial.EvtTabRubrica.InfoRubrica infoRubrica = objectFactory.createESocialEvtTabRubricaInfoRubrica();
    ...
    protected Alteracao infoRubricaToAlteracao(InfoRubrica infoRubrica) {
        if ( infoRubrica == null ) {
            return null;
        }
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tabrubrica.ESocial.EvtTabRubrica.InfoRubrica tabelaRubricaToInfoRubrica1(TabelaRubrica tabelaRubrica) {
        if ( tabelaRubrica == null ) {
            return null;
        }
    ...
    protected Exclusao infoRubricaToExclusao(InfoRubrica infoRubrica) {
        if ( infoRubrica == null ) {
            return null;
        }
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tabrubrica.ESocial.EvtTabRubrica.InfoRubrica tabelaRubricaToInfoRubrica2(TabelaRubrica tabelaRubrica) {
        if ( tabelaRubrica == null ) {
            return null;
        }
