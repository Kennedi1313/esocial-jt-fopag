...
import br.jus.tst.esocial.dominio.vinculo.alteracaocontratual.InfoRegimeTrab;
import br.jus.tst.esocial.dominio.vinculo.alteracaocontratual.TrabTemporario;
...
public class AltContratualMapperImpl extends AltContratualMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario trabTemporarioToTrabTemporario(TrabTemporario trabTemporario) {
        if ( trabTemporario == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoCeletista.TrabTemporario trabTemporario1 = objectFactory.createESocialEvtAltContratualAltContratualVinculoInfoRegimeTrabInfoCeletistaTrabTemporario();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoCeletista infoCeletistaToInfoCeletista(InfoCeletista infoCeletista) {
        if ( infoCeletista == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoCeletista infoCeletista1 = objectFactory.createESocialEvtAltContratualAltContratualVinculoInfoRegimeTrabInfoCeletista();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoEstatutario infoEstatutarioToInfoEstatutario(InfoEstatutario infoEstatutario) {
        if ( infoEstatutario == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab.InfoEstatutario infoEstatutario1 = objectFactory.createESocialEvtAltContratualAltContratualVinculoInfoRegimeTrabInfoEstatutario();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab infoRegimeTrabToInfoRegimeTrab(InfoRegimeTrab infoRegimeTrab) {
        if ( infoRegimeTrab == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoRegimeTrab infoRegimeTrab1 = objectFactory.createESocialEvtAltContratualAltContratualVinculoInfoRegimeTrab();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoContrato.Duracao duracaoToDuracao(Duracao duracao) {
        if ( duracao == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo.InfoContrato.Duracao duracao1 = objectFactory.createESocialEvtAltContratualAltContratualVinculoInfoContratoDuracao();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo vinculoToVinculo(Vinculo vinculo) {
        if ( vinculo == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.altcontratual.ESocial.EvtAltContratual.AltContratual.Vinculo vinculo1 = objectFactory.createESocialEvtAltContratualAltContratualVinculo();
