...
public class TSVAltContrMapperImpl extends TSVAltContrMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao.InfoComplementares.InfoTrabCedido infoTrabCedidoToInfoTrabCedido(InfoTrabCedido infoTrabCedido) {
        if ( infoTrabCedido == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao.InfoComplementares.InfoTrabCedido infoTrabCedido1 = objectFactory.createESocialEvtTSVAltContrInfoTSVAlteracaoInfoComplementaresInfoTrabCedido();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao.InfoComplementares.InfoMandElet infoMandEletToInfoMandElet(InfoMandElet infoMandElet) {
        if ( infoMandElet == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao.InfoComplementares.InfoMandElet infoMandElet1 = objectFactory.createESocialEvtTSVAltContrInfoTSVAlteracaoInfoComplementaresInfoMandElet();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.TInfoEstagiario.InstEnsino instEnsinoToInstEnsino(InstEnsino instEnsino) {
        if ( instEnsino == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.TInfoEstagiario.InstEnsino instEnsino1 = objectFactory.createTInfoEstagiarioInstEnsino();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao infoTSVAlteracaoToInfoTSVAlteracao(InfoTSVAlteracao infoTSVAlteracao) {
        if ( infoTSVAlteracao == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.tsvaltcontr.ESocial.EvtTSVAltContr.InfoTSVAlteracao infoTSVAlteracao1 = objectFactory.createESocialEvtTSVAltContrInfoTSVAlteracao();
