...
import br.jus.tst.esocial.dominio.desligamento.ConsigFGTS;
...
import br.jus.tst.esocial.dominio.desligamento.InfoPerAnt;
import br.jus.tst.esocial.dominio.desligamento.ProcCS;
import br.jus.tst.esocial.dominio.desligamento.SucessaoVinc;
import br.jus.tst.esocial.dominio.desligamento.VerbasResc;
...
public class DesligMapperImpl extends DesligMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.SucessaoVinc sucessaoVincToSucessaoVinc(SucessaoVinc sucessaoVinc) {
        if ( sucessaoVinc == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.SucessaoVinc sucessaoVinc1 = objectFactory.createESocialEvtDesligInfoDesligSucessaoVinc();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.MudancaCPF mudancaCPFToMudancaCPF(MudancaCPF mudancaCPF) {
        if ( mudancaCPF == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.MudancaCPF mudancaCPF1 = objectFactory.createESocialEvtDesligInfoDesligMudancaCPF();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr remunOutrEmprToRemunOutrEmpr(RemunOutrEmpr remunOutrEmpr) {
        if ( remunOutrEmpr == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr remunOutrEmpr1 = objectFactory.createTInfoMVRemunOutrEmpr();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr> remunOutrEmprListToRemunOutrEmprList(List<RemunOutrEmpr> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr>( list.size() );
    ...
    protected TInfoMV infoMVToTInfoMV(InfoMV infoMV) {
        ...
        if ( tInfoMV.getRemunOutrEmpr() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.deslig.TInfoMV.RemunOutrEmpr> list = remunOutrEmprListToRemunOutrEmprList( infoMV.getRemunOutrEmpr() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.ProcCS procCSToProcCS(ProcCS procCS) {
        if ( procCS == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.ProcCS procCS1 = objectFactory.createESocialEvtDesligInfoDesligVerbasRescProcCS();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.InfoAgNocivo infoAgNocivoToInfoAgNocivo(InfoAgNocivo infoAgNocivo) {
        if ( infoAgNocivo == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.InfoAgNocivo infoAgNocivo1 = objectFactory.createTIdeEstabLotInfoAgNocivo();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas detVerbasToDetVerbas(DetVerbas detVerbas) {
        if ( detVerbas == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas detVerbas1 = objectFactory.createTIdeEstabLotDetVerbas();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas> detVerbasListToDetVerbasList(List<DetVerbas> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas>( list.size() );
    ...
    protected TIdeEstabLot ideEstabLotToTIdeEstabLot(IdeEstabLot ideEstabLot) {
        ...
        if ( tIdeEstabLot.getDetVerbas() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.deslig.TIdeEstabLot.DetVerbas> list = detVerbasListToDetVerbasList( ideEstabLot.getDetVerbas() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC ideADCToIdeADC(IdeADC ideADC) {
        if ( ideADC == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC ideADC1 = objectFactory.createESocialEvtDesligInfoDesligVerbasRescDmDevInfoPerAntIdeADC();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC> ideADCListToIdeADCList(List<IdeADC> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC>( list.size() );
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt infoPerAntToInfoPerAnt(InfoPerAnt infoPerAnt) {
        if ( infoPerAnt == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt infoPerAnt1 = objectFactory.createESocialEvtDesligInfoDesligVerbasRescDmDevInfoPerAnt();

        if ( infoPerAnt1.getIdeADC() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeADC> list = ideADCListToIdeADCList( infoPerAnt.getIdeADC() );
            if ( list != null ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc verbasRescToVerbasResc(VerbasResc verbasResc) {
        if ( verbasResc == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.VerbasResc verbasResc1 = objectFactory.createESocialEvtDesligInfoDesligVerbasResc();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.Quarentena quarentenaToQuarentena(Quarentena quarentena) {
        if ( quarentena == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.Quarentena quarentena1 = objectFactory.createESocialEvtDesligInfoDesligQuarentena();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS consigFGTSToConsigFGTS(ConsigFGTS consigFGTS) {
        if ( consigFGTS == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS consigFGTS1 = objectFactory.createESocialEvtDesligInfoDesligConsigFGTS();
    ...
    protected List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS> consigFGTSListToConsigFGTSList(List<ConsigFGTS> list) {
        if ( list == null ) {
            return null;
        }

        List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS> list1 = new ArrayList<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS>( list.size() );
        for ( ConsigFGTS consigFGTS : list ) {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig infoDesligToInfoDeslig(InfoDeslig infoDeslig) {
        if ( infoDeslig == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig infoDeslig1 = objectFactory.createESocialEvtDesligInfoDeslig();
        ...
        if ( infoDeslig1.getConsigFGTS() != null ) {
            List<br.jus.tst.esocial.esquemas.eventos.deslig.ESocial.EvtDeslig.InfoDeslig.ConsigFGTS> list2 = consigFGTSListToConsigFGTSList( infoDeslig.getConsigFGTS() );
            if ( list2 != null ) {
