...
import br.jus.tst.esocial.dominio.beneficio.demonstrativovalores.InfoPerAnt;
import br.jus.tst.esocial.dominio.beneficio.demonstrativovalores.InfoPerApur;
...
public class BenPrRPMapperImpl extends BenPrRPMapper {
    ...
    protected br.jus.tst.esocial.esquemas.eventos.benprrp.ESocial.EvtBenPrRP.DmDev.InfoPerApur infoPerApurToInfoPerApur(InfoPerApur infoPerApur) {
        if ( infoPerApur == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.benprrp.ESocial.EvtBenPrRP.DmDev.InfoPerApur infoPerApur1 = objectFactory.createESocialEvtBenPrRPDmDevInfoPerApur();
    ...
    protected br.jus.tst.esocial.esquemas.eventos.benprrp.ESocial.EvtBenPrRP.DmDev.InfoPerAnt infoPerAntToInfoPerAnt(InfoPerAnt infoPerAnt) {
        if ( infoPerAnt == null ) {
            return null;
        }

        br.jus.tst.esocial.esquemas.eventos.benprrp.ESocial.EvtBenPrRP.DmDev.InfoPerAnt infoPerAnt1 = objectFactory.createESocialEvtBenPrRPDmDevInfoPerAnt();
