...
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao;
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador;
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.Dependente;
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.Endereco;
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.InfoDeficiencia;
import br.jus.tst.esocial.esquemas.eventos.altcadastral.ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.TrabImig;
...
public class AltCadastralMapperImpl extends AltCadastralMapper {
    ...
    protected Endereco enderecoToEndereco(br.jus.tst.esocial.dominio.endereco.Endereco endereco) {
        ...
        Endereco endereco1 = objectFactory.createESocialEvtAltCadastralAlteracaoDadosTrabalhadorEndereco();
    ...
    protected TrabImig trabImigToTrabImig(br.jus.tst.esocial.dominio.trabalhador.TrabImig trabImig) {
        ...
        TrabImig trabImig1 = objectFactory.createESocialEvtAltCadastralAlteracaoDadosTrabalhadorTrabImig();
    ...
    protected InfoDeficiencia infoDeficienciaToInfoDeficiencia(br.jus.tst.esocial.dominio.trabalhador.InfoDeficiencia infoDeficiencia) {
        ...
        InfoDeficiencia infoDeficiencia1 = objectFactory.createESocialEvtAltCadastralAlteracaoDadosTrabalhadorInfoDeficiencia();
    ...
    protected Dependente dependenteToDependente(br.jus.tst.esocial.dominio.trabalhador.Dependente dependente) {
        ...
        Dependente dependente1 = objectFactory.createESocialEvtAltCadastralAlteracaoDadosTrabalhadorDependente();
    ...
    protected DadosTrabalhador dadosTrabalhadorToDadosTrabalhador(br.jus.tst.esocial.dominio.trabalhador.alteracaocadastral.DadosTrabalhador dadosTrabalhador) {
        if ( dadosTrabalhador == null ) {
            return null;
        }

        DadosTrabalhador dadosTrabalhador1 = objectFactory.createESocialEvtAltCadastralAlteracaoDadosTrabalhador();
        ...
        if ( dadosTrabalhador1.getDependente() != null ) {
            List<Dependente> list = dependenteListToDependenteList( dadosTrabalhador.getDependente() );
            if ( list != null ) {
    ...
    protected Alteracao alteracaoToAlteracao(br.jus.tst.esocial.dominio.trabalhador.alteracaocadastral.Alteracao alteracao) {
        if ( alteracao == null ) {
            return null;
        }

        Alteracao alteracao1 = objectFactory.createESocialEvtAltCadastralAlteracao();
