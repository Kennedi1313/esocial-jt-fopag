...
import br.jus.tst.esocial.esquemas.eventos.tabestab.ESocial.EvtTabEstab.InfoEstab;
...
import br.jus.tst.esocial.esquemas.eventos.tabestab.TDadosEstab.AliqGilrat.ProcAdmJudFap;
...
import br.jus.tst.esocial.esquemas.eventos.tabestab.TDadosEstab.InfoTrab;
...
public class TabelaEstabelecimentoMapperImpl extends TabelaEstabelecimentoMapper {
    ...
    protected ProcAdmJudFap procAdmJudFapToProcAdmJudFap(br.jus.tst.esocial.dominio.tabela.estabelecimento.ProcAdmJudFap procAdmJudFap) {
        if ( procAdmJudFap == null ) {
            return null;
        }

        ProcAdmJudFap procAdmJudFap1 = objectFactory.createTDadosEstabAliqGilratProcAdmJudFap();
    ...
    protected InfoTrab infoTrabToInfoTrab(br.jus.tst.esocial.dominio.tabela.estabelecimento.InfoTrab infoTrab) {
        if ( infoTrab == null ) {
            return null;
        }

        InfoTrab infoTrab1 = objectFactory.createTDadosEstabInfoTrab();
    ...
    protected Inclusao infoEstabToInclusao(br.jus.tst.esocial.dominio.tabela.estabelecimento.InfoEstab infoEstab) {
        if ( infoEstab == null ) {
            return null;
        }
    ...
    protected InfoEstab tabelaEstabelecimentoToInfoEstab(TabelaEstabelecimento tabelaEstabelecimento) {
        if ( tabelaEstabelecimento == null ) {
            return null;
        }

        InfoEstab infoEstab = objectFactory.createESocialEvtTabEstabInfoEstab();
    ...
    protected Alteracao infoEstabToAlteracao(br.jus.tst.esocial.dominio.tabela.estabelecimento.InfoEstab infoEstab) {
        if ( infoEstab == null ) {
            return null;
        }
    ...
    protected InfoEstab tabelaEstabelecimentoToInfoEstab1(TabelaEstabelecimento tabelaEstabelecimento) {
        if ( tabelaEstabelecimento == null ) {
            return null;
        }
    ...
    protected Exclusao infoEstabToExclusao(br.jus.tst.esocial.dominio.tabela.estabelecimento.InfoEstab infoEstab) {
        if ( infoEstab == null ) {
            return null;
        }
    ...
    protected InfoEstab tabelaEstabelecimentoToInfoEstab2(TabelaEstabelecimento tabelaEstabelecimento) {
        if ( tabelaEstabelecimento == null ) {
            return null;
        }
