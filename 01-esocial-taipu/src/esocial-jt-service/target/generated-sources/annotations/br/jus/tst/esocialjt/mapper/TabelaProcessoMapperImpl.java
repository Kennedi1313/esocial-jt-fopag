...
import br.jus.tst.esocial.esquemas.eventos.tabprocesso.ESocial.EvtTabProcesso.InfoProcesso;
...
public class TabelaProcessoMapperImpl extends TabelaProcessoMapper {
    ...
    protected Inclusao infoProcessoToInclusao(br.jus.tst.esocial.dominio.tabela.processo.InfoProcesso infoProcesso) {
    ...
    protected InfoProcesso tabelaProcessoToInfoProcesso(TabelaProcesso tabelaProcesso) {
        if ( tabelaProcesso == null ) {
            return null;
        }

        InfoProcesso infoProcesso = objectFactory.createESocialEvtTabProcessoInfoProcesso();
    ...
    protected Alteracao infoProcessoToAlteracao(br.jus.tst.esocial.dominio.tabela.processo.InfoProcesso infoProcesso) {
        if ( infoProcesso == null ) {
            return null;
        }
    ...
    protected InfoProcesso tabelaProcessoToInfoProcesso1(TabelaProcesso tabelaProcesso) {
        if ( tabelaProcesso == null ) {
            return null;
        }
    ...
    protected Exclusao infoProcessoToExclusao(br.jus.tst.esocial.dominio.tabela.processo.InfoProcesso infoProcesso) {
        if ( infoProcesso == null ) {
            return null;
        }
    ...
    protected InfoProcesso tabelaProcessoToInfoProcesso2(TabelaProcesso tabelaProcesso) {
        if ( tabelaProcesso == null ) {
            return null;
        }
