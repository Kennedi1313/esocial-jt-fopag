...
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio.Afastamento;
...
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio.InfoComplementares.FGTS;
...
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio.InfoComplementares.InfoMandElet;
...
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio.MudancaCPF;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.InfoTSVInicio.Termino;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.Trabalhador;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.Trabalhador.Dependente;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.Trabalhador.Endereco;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.Trabalhador.InfoDeficiencia;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.ESocial.EvtTSVInicio.Trabalhador.TrabImig;
...
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.TInfoEstagiario.AgeIntegracao;
import br.jus.tst.esocial.esquemas.eventos.tsvinicio.TInfoEstagiario.InstEnsino;
...
public class TSVInicioMapperImpl extends TSVInicioMapper {
    ...
    protected Endereco enderecoToEndereco(br.jus.tst.esocial.dominio.endereco.Endereco endereco) {
        ...
        Endereco endereco1 = objectFactory.createESocialEvtTSVInicioTrabalhadorEndereco();
    ...
    protected TrabImig trabImigToTrabImig(br.jus.tst.esocial.dominio.trabalhador.TrabImig trabImig) {
        ...
        TrabImig trabImig1 = objectFactory.createESocialEvtTSVInicioTrabalhadorTrabImig();
    ...
    protected InfoDeficiencia infoDeficienciaToInfoDeficiencia(br.jus.tst.esocial.dominio.trabalhador.InfoDeficiencia infoDeficiencia) {
        ...
        InfoDeficiencia infoDeficiencia1 = objectFactory.createESocialEvtTSVInicioTrabalhadorInfoDeficiencia();
    ...
    protected Dependente dependenteToDependente(br.jus.tst.esocial.dominio.trabalhador.Dependente dependente) {
        ...
        Dependente dependente1 = objectFactory.createESocialEvtTSVInicioTrabalhadorDependente();
    ...
    protected Trabalhador trabalhadorToTrabalhador(br.jus.tst.esocial.dominio.trabalhador.Trabalhador trabalhador) {
        ...
        Trabalhador trabalhador1 = objectFactory.createESocialEvtTSVInicioTrabalhador();
    ...
    protected FGTS fGTSToFGTS(br.jus.tst.esocial.dominio.semvinculo.FGTS fGTS) {
        if ( fGTS == null ) {
            return null;
        }

        FGTS fGTS1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicioInfoComplementaresFGTS();
    ...
    protected InfoMandElet infoMandEletToInfoMandElet(br.jus.tst.esocial.dominio.semvinculo.InfoMandElet infoMandElet) {
        ...
        InfoMandElet infoMandElet1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicioInfoComplementaresInfoMandElet();
    ...
    protected MudancaCPF mudancaCPFToMudancaCPF(br.jus.tst.esocial.dominio.semvinculo.MudancaCPF mudancaCPF) {
        if ( mudancaCPF == null ) {
            return null;
        }

        MudancaCPF mudancaCPF1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicioMudancaCPF();
    ...
    protected Afastamento afastamentoToAfastamento(br.jus.tst.esocial.dominio.vinculo.Afastamento afastamento) {
        ...
        Afastamento afastamento1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicioAfastamento();
    ...
    protected Termino terminoToTermino(br.jus.tst.esocial.dominio.semvinculo.Termino termino) {
        if ( termino == null ) {
            return null;
        }

        Termino termino1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicioTermino();
    ...
    protected InfoTSVInicio infoTSVInicioToInfoTSVInicio(br.jus.tst.esocial.dominio.semvinculo.InfoTSVInicio infoTSVInicio) {
        if ( infoTSVInicio == null ) {
            return null;
        }

        InfoTSVInicio infoTSVInicio1 = objectFactory.createESocialEvtTSVInicioInfoTSVInicio();
