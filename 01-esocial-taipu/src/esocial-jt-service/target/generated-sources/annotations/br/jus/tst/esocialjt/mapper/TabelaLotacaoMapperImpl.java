...
import br.jus.tst.esocial.esquemas.eventos.tablotacao.TDadosLotacao.DadosOpPort;
import br.jus.tst.esocial.esquemas.eventos.tablotacao.TDadosLotacao.FpasLotacao;
import br.jus.tst.esocial.esquemas.eventos.tablotacao.TDadosLotacao.FpasLotacao.InfoProcJudTerceiros;
import br.jus.tst.esocial.esquemas.eventos.tablotacao.TDadosLotacao.FpasLotacao.InfoProcJudTerceiros.ProcJudTerceiro;
import br.jus.tst.esocial.esquemas.eventos.tablotacao.TDadosLotacao.InfoEmprParcial;
...
public class TabelaLotacaoMapperImpl extends TabelaLotacaoMapper {
    ...
    protected InfoProcJudTerceiros infoProcJudTerceirosToInfoProcJudTerceiros(br.jus.tst.esocial.dominio.tabela.lotacao.InfoProcJudTerceiros infoProcJudTerceiros) {
        if ( infoProcJudTerceiros == null ) {
            return null;
        }

        InfoProcJudTerceiros infoProcJudTerceiros1 = objectFactory.createTDadosLotacaoFpasLotacaoInfoProcJudTerceiros();
    ...
    protected FpasLotacao fpasLotacaoToFpasLotacao(br.jus.tst.esocial.dominio.tabela.lotacao.FpasLotacao fpasLotacao) {
        if ( fpasLotacao == null ) {
            return null;
        }

        FpasLotacao fpasLotacao1 = objectFactory.createTDadosLotacaoFpasLotacao();
    ...
    protected InfoEmprParcial infoEmprParcialToInfoEmprParcial(br.jus.tst.esocial.dominio.tabela.lotacao.InfoEmprParcial infoEmprParcial) {
        if ( infoEmprParcial == null ) {
            return null;
        }

        InfoEmprParcial infoEmprParcial1 = objectFactory.createTDadosLotacaoInfoEmprParcial();
    ...
    protected DadosOpPort dadosOpPortToDadosOpPort(br.jus.tst.esocial.dominio.tabela.lotacao.DadosOpPort dadosOpPort) {
        if ( dadosOpPort == null ) {
            return null;
        }

        DadosOpPort dadosOpPort1 = objectFactory.createTDadosLotacaoDadosOpPort();
